    ...
    <div class="container-fluid">
        <div class="quick-actions_homepage">
            <ul class="quick-actions">
                ...
                <li class="bg_lo"> <a href="/admin/student/courses_student"> <i class="icon-th"></i>  Student to courses</a> </li>
                <!-- <li class="bg_ls"> <a href="grid.html"> <i class="icon-fullscreen"></i> Full width</a> </li> -->
                <!-- <li class="bg_lb"> <a href="/admin/courses_session"> <i class="icon-pencil"></i>Tables Courses  Session</a> </li> -->
                <li class="bg_ly"> <a href="/admin/courses_session"> <i class="icon-calendar"></i> Courses  Session </a> </li>
